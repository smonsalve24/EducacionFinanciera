        ...
        <div class="sidebar col-xs-2 col-sm-2 col-md-2 col-lg-2" style="position: relative !important">
            <!-- Left Side Of Navbar -->
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                  ...
                  <li>
                    <a href="{{ url('users') }}" class="nav-link text-white {{Request::is('users') ? 'active' : '' }}" aria-current="page">
                  ...
                  <li>
                    <a href="{{ url('recomendaciones') }}" class="nav-link text-white {{Request::is('recomendaciones') ? 'active' : '' }}" aria-current="page">
