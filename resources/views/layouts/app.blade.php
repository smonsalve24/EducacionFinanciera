                          ...
                          <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#"
                                    ...
                                    <img src="https://picsum.photos/700/400?random" alt="" width="32"
                ...
                <div class=" col-xs-2 col-sm-2 col-md-2 col-lg-2 position-relative" >
                  <div class="sidebar"  style="position: absolute !important">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li>
                                <a href="{{ url('users') }}"
                                    class="nav-link text-white {{ Request::is('users') ? 'active' : '' }}"
                                    aria-current="page">
                                    <svg class="bi me-2" width="16" height="16">
                    ...
                    <a href="{{ url('personas') }}" class="nav-link text-white {{Request::is('personas') ? 'active' : '' }}" aria-current="page">
                      ...
                      Personas
                            ...
                            <li>
                                <a href="{{ url('categoria-ingreso') }}"
                                    class="nav-link text-white {{ Request::is('categoria-ingreso') ? 'active' : '' }}"
                                    aria-current="page">
                                    <svg class="bi me-2" width="16" height="16">
                            ...
                            <li>
                                <a href="{{ url('categoria-egreso') }}"
                                    class="nav-link text-white {{ Request::is('categoria-egreso') ? 'active' : '' }}"
                                    aria-current="page">
                                    <svg class="bi bi-arrow-left-square" width="16" height="16">
                                        <use xlink:href="#table"></use>
                                    </svg>
