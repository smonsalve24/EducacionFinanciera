...
@if(isset($slider))
    ...
    {!! Form::open(array('url'=> '/administrador/clientes/'.$slider['id'], 'method'=> 'PUT', 'files' => true ,)) !!}
    {!! Form::token() !!}
		<div class="form-horizontal">
    		...
    		<div class="form-group">
    			...
    			<div class="col-md-3">
    				<a href="{{url('administrador/clientes')}}" class="btn btn-danger">Cancelar y Regresar</a>
    			</div>
    		</div>
    	</div>
	{{Form::close()}}
