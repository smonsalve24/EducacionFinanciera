...
<div class="panel-header">
    ...
    <ul class="nav nav-tabs text-regular" role="tablist">
        <li role="presentation" class="active">
            <a href="{{ Request::is('administrador/clientes/create') ? '/#perfil' : '#perfil' }} " aria-controls="perfil" role="tab" data-toggle="tab">Entradas</a>
        </li>
        <li role="presentation">
            <a href="{{ Request::is('administrador/clientes/create') ? '/#solicitud' : '#solicitud' }}" aria-controls="solicitud" role="tab" data-toggle="tab">Crear Nuevo</a>
        </li>
    </ul>
</div>
<div>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="perfil"><br>
			...
			@if(isset($clientes))
				@foreach($clientes as $directorio)
					<tr>
						<td>
							<h5 class="text-center">
								{{$directorio['id']}}
						...
						<td class="text-center">
							<a href="{{url('administrador/clientes/'.$directorio['id'])}}" class="text-center text-success btn">
		...
		<div role="tabpanel" class="tab-pane " id="solicitud"><br>
			<h3 class="text-bold text-success">Creación de clientes</h3>
				<p class="">
					<small>
				...
				{!! Form::open(array('url'=> '/administrador/clientes','method'=> 'POST', 'class' => '', 'files' => true , )) !!}
			    {!! Form::token() !!}
...
@if(isset($clientes))
	@foreach($clientes as $directorio)
		...
		<div class="modal fade" id="myModal{{$directorio['id']}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		    ...
		    {!! Form::open(array('url'=> '/administrador/clientes/'.$directorio['id'], 'method'=> 'DELETE', 'files' => true ,)) !!}
		    {!! Form::token() !!}
